...
class MyJobDetailsPage extends StatefulWidget {
  ...
  const MyJobDetailsPage({Key? key, required this.request, this.worker}) : super(key: key);
...
class _MyJobDetailsPageState extends State<MyJobDetailsPage> {
  ...
  void _openChat() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ChatConversationPage(conversation: conversation, currentUser: worker),
      ),
    );
  }
          ...
          children: [
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text(widget.request.type,
                            style: const TextStyle(fontSize: 12, color: Color(0xFF2D7A5E), fontWeight: FontWeight.w600)),
                      ),
                      const Spacer(),
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                  ...
                  if (widget.request.userAddress != null) ...[
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(widget.request.userAddress!,
                              style: TextStyle(fontSize: 13, color: Colors.grey[600]),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Your Quoted Price', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                  const SizedBox(height: 8),
                  TextField(
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('Message Client', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Mark as Done', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
              ),
            ),
